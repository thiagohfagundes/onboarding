...
def sign_in_card():
    return rx.el.div(
        rx.el.div(
            ...
            rx.el.p(
                "Insira seu e-mail abaixo para fazer o login",
        ...
        rx.el.form(
            rx.el.div(
                rx.el.label("E-mail", class_name="text-sm font-medium leading-none"),
                rx.el.input(
                    type="email",
            ...
            rx.el.div(
                rx.el.label("Senha", class_name="text-sm font-medium leading-none"),
                rx.el.input(
                    type="password",
                    name="password",
                    required=True,
        ...
        class_name="p-6 rounded-xl bg-white flex flex-col gap-4 shadow-sm border border-gray-200 text-black min-w-[27rem]",
    )
...
def sign_up_card():
    return rx.el.div(
        rx.el.div(
            rx.el.h1(
                "Crie uma conta", class_name="font-semibold tracking-tight text-xl"
            ),
            rx.el.p(
                "Insira seu e-mail abaixo para criar uma nova conta",
                class_name="text-sm text-gray-500 font-medium",
            ),
            class_name="flex flex-col",
        ),
